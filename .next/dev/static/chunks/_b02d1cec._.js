...
function MetricCard(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "eb8dacff1dd1172edfe8e88ad5b4cb1626c3029f2f57b65124d89b38f7af0bd4") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "eb8dacff1dd1172edfe8e88ad5b4cb1626c3029f2f57b65124d89b38f7af0bd4";
    }
...
function useSensorData(metric) {
    ...
    if ($[2] !== metric) {
        t1 = ({
            "useSensorData[useEffect()]": ()=>{
                const extracted = mockSensorData.map({
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = mockSensorData.map(_useSensorDataMockSensorDataMap);
        $[7] = t6;
    } else {
        t6 = $[7];
    }
...
function MetricDisplaySection(t0) {
    ...
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = mockSensorData.map(_MetricDisplaySectionMockSensorDataMap);
        $[1] = t1;
    } else {
        t1 = $[1];
    }
...
//# sourceMappingURL=_b02d1cec._.js.map